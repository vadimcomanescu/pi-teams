...
## Status
Finished and archived on 2026-04-13.

This plan is complete. The shipped contract now has:
- one `/team` operator surface
- live teammate activity visible in roster, detail, and compact widget surfaces
- inbox-backed teammate messaging and graceful shutdown flow
- clean shutdown vs delete semantics
